...
public class NotificationController implements NotificationApi {
    ...
    @Override
    public ResponseEntity<List<NotificationDto>> getAllCustomerRatings(Long id) {
        List<NotificationDto> notificationDtoList = notificationService.findFindListRatingByCustomerId(id);
        return new ResponseEntity(notificationDtoList, HttpStatus.OK);
    }
